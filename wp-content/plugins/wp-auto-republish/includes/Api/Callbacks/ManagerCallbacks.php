...
class ManagerCallbacks
{
    ...
    public function minimun_republish_interval( $args )
    {
        ...
        _e( 'Select post republish interval between two post republish event.', 'wp-auto-republish' );
        ?>"><span title="" class="dashicons dashicons-editor-help"></span></span>
		<?php 
    }
    ...
    public function republish_time_start( $args )
    {
        ...
        ?>" />
        &nbsp;&nbsp;<span class="tooltip" title="<?php 
        _e( 'Set the starting time period for republish old posts from here.', 'wp-auto-republish' );
        ?>"><span title="" class="dashicons dashicons-editor-help"></span></span>
        <?php 
    }
    ...
    public function republish_time_end( $args )
    {
        ...
        ?>" />
        &nbsp;&nbsp;<span class="tooltip" title="<?php 
        _e( 'Set the ending time period for republish old posts from here.', 'wp-auto-republish' );
        ?>"><span title="" class="dashicons dashicons-editor-help"></span></span>
        <?php 
    }
    ...
    public function republish_post_age( $args )
    {
        ...
        ?>
		&nbsp;&nbsp;<span class="tooltip" title="<?php 
        _e( 'Select the post age for republishing. Post actually published before this, will be available for republish.', 'wp-auto-republish' );
        ?>"><span title="" class="dashicons dashicons-editor-help"></span></span>
		<?php 
    }
    ...
    public function exclude_by_type( $args )
    {
        ...
        ?>
        &nbsp;&nbsp;<span class="tooltip" title="<?php 
        _e( 'Select how you want to include or exclude a post category from republishing. If you choose excluding, selected taxonomies will be ignored and vice-versa.', 'wp-auto-republish' );
        ?>"><span title="" class="dashicons dashicons-editor-help"></span></span>
        <?php 
    }
    ...
    public function post_taxonomy( $args )
    {
        ...
        ?>
        &nbsp;&nbsp;<span class="tooltip" title="<?php 
        _e( 'Select taxonimies which you want to include to republishing or exclude from republishing.', 'wp-auto-republish' );
        ?>"><span title="" class="dashicons dashicons-editor-help"></span></span>
        <?php 
    }
    ...
    public function email_subject( $args )
    {
        ...
        ?>" />
		<?php 
        printf( '<small style="line-height: 2;"><i>%s</i><code>&#37;post_title&#37;</code> <code>&#37;author_name&#37;</code> <code>&#37;post_type&#37;</code> <code>&#37;site_name&#37;</code> <code>&#37;site_url&#37;</code> <code>&#37;republish_time&#37;</code><small>', __( 'Use these tags into email subject - ', 'wp-auto-republish' ) );
    }
