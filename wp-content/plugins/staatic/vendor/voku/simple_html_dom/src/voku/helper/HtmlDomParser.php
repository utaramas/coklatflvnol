...
class HtmlDomParser extends AbstractDomParser
{
     ...
     */
    public function fixHtmlOutput($content, $multiDecodeNewHtmlEntity = \false) : string
    {
     ...
     */
    public function setCallbackXPathBeforeQuery($callbackXPathBeforeQuery)
    {
     ...
     */
    public function setCallbackBeforeCreateDom($callbackBeforeCreateDom)
    {
