...
final class XmlSitemapUrlSetUrlExtractor implements UrlExtractorInterface
{
    /**
     * @var \Closure|null
     */
    ...
    public function extract($source, $baseUrl) : \Generator
    {
        foreach ($this->getPatterns() as $pattern) {
            $yieldUrls = [];
            \preg_replace_callback($pattern, function ($match) use(&$yieldUrls, $baseUrl) {
